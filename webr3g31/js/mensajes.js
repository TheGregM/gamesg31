...
function editar(id) {
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            ...
            //Asigna la información obtenida tras la invocaciòn del ws a cada uno de los campos del formulario
            ...
            let farmIdModif = document.getElementById("gameIdModif")
            ...
            gameIdModif.value = respuesta.farm.id
    ...
    xhttp.open(
        "GET",
        url + "https://g0ec51ed4887632-rluyfwecd7v9mjbe.adb.mx-queretaro-1.oraclecloudapps.com/ords/admin/message/message" + id,
        true
    );
    xhttp.send();
}
...
function eliminar(id) {
    let url = "https://g0ec51ed4887632-rluyfwecd7v9mjbe.adb.mx-queretaro-1.oraclecloudapps.com/ords/admin/message/message"
    ...
    solicitud.onreadystatechange = function () {
        ...
        if (solicitud.readyState == 4 && solicitud.status == 200) {
            ...
            document.getElementById("gameList").innerHTML = "<strong>Juego: </strong>" + respuesta.game.id
...
function guardarNuevo() {
    ...
    url = "https://g0ec51ed4887632-rluyfwecd7v9mjbe.adb.mx-queretaro-1.oraclecloudapps.com/ords/admin/message/message";
