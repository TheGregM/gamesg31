...
function editar(id) {
    ...
    xhttp.open(
        "GET",
        "https://g0ec51ed4887632-rluyfwecd7v9mjbe.adb.mx-queretaro-1.oraclecloudapps.com/ords/admin/games/games" + id,
        true
    );
    xhttp.send();
}
...
function eliminar(id) {
    let url = "https://g0ec51ed4887632-rluyfwecd7v9mjbe.adb.mx-queretaro-1.oraclecloudapps.com/ords/admin/games/games"
