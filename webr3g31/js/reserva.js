...
function editar(id) {
  ...
  let url =
    "https://g0ec51ed4887632-rluyfwecd7v9mjbe.adb.mx-queretaro-1.oraclecloudapps.com/ords/admin/games/games";
...
*/
  peticion.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("idLabel").innerHTML = "<strong>Game id :</strong>" + idModif
...
*/
  peticion.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("idList").innerHTML = "<strong>Game id :</strong>" + idModif
      ...
      document.getElementById("category_idList").innerHTML = "<strong>Game categoryId :</strong>" + categoryIdModif
      document.getElementById("nameList").innerHTML = "<strong>Game Name :</strong>" + nameModif
